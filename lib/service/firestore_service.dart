...
class FirestoreService {
  ...
  Future<void> sendFriendRequest(FriendRequestModel request) async {
    try {
      ...
      String notificationId =
          'friend_request_${request.senderId} ${request.receiverId} ${DateTime.now().millisecondsSinceEpoch}';
  ...
  Future<FriendRequestModel> getFriendRequests(
    ...
    try {
      ...
      throw Exception('Error fetching friend request: $e');
    }
  }
  ...
  Future<void> removeFriendShip(String user1Id, String user2Id) async {
    try {
      ...
      throw Exception('Failed to remove friendshipt: ${e.toString()}');
    }
  }
